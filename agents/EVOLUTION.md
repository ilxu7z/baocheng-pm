...
# EVOLUTION.md · 鮱澄军团自进化协议

> **目标**：让每个 Agent 越做越好，经验自动沉淀，Skill 自主创建并进化。
> **驱动者**：运维主管（运维）—— 系统进化引擎的核心执行者。
...
## 3. 复盘触发机制
- 交付主管（Layer 6 交付）→ 标准复盘
- 品控官（Layer 5 打回）→ 深度复盘（含根因分析）
...
## 5. Skill 进化管理
- 草稿 → 使用≥3次 → 已验证 → 成功率>80% → 晋升候选 → 运维主管审查 → 已晋升 → 使用≥5次 → 已固化
- 打回率>30% → 降级
- 连续30天未触发 → 淘汰
